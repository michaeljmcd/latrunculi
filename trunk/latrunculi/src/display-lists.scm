...
; texture 1 will be the board's texture, 2 will be black and 3 will be white.
		  (define pine-img (tga-data "../img/pine.tga"))
		  (define pine-pix (list->u8vector (vector->list (vector-ref pine-img 3))))
		  (define granite-img (tga-data "../img/granite.tga"))
		  (define granite-pix (list->u8vector (vector->list (vector-ref granite-img 3))))
		  (define marble-img (tga-data "../img/white_marble.tga"))
		  (define marble-pix (list->u8vector (vector->list (vector-ref marble-img 3))))
		  (define quad (glu:NewQuadric))
